...
function setupAccordionControlPanel()
{
    ...
    $j("#accorPlayBtn").click(
        function()
        {
            ...
            if(true == g_sliderAutoPlay)
            {
                 $j(this).attr("src", "/SeniorProject/img/slider/accordion/control/pause_hover.png");
            } else
            {
                  $j(this).attr("src", "/SeniorProject/img/slider/accordion/control/play_hover.png");
            }
        }
    );
    ...
    $j("#accorPlayBtn").hover(
        ...
        function ()
        {
            if(false == g_sliderAutoPlay)
            {
                $j(this).attr("src", "/SeniorProject/img/slider/accordion/control/play.png");
            } else
            {
                $j(this).attr("src", "/SeniorProject/img/slider/accordion/control/pause.png")
            }
    ...
    $j("#accorBackBtn").hover(
        function ()
        {
           ...
           $j(this).attr("src", "/SeniorProject/img/slider/accordion/control/back_hover.png");
        },
        function ()
        {
            $j(this).attr("src", "/SeniorProject/img/slider/accordion/control/back.png");
            $j("#accorControlBtnDesc").stop().fadeTo(0, 0.0); 
        }
    );
    ...
    $j("#accorForwardBtn").hover(
        function ()
        {
            ...
            $j(this).attr("src", "/SeniorProject/img/slider/accordion/control/forward_hover.png");
        },
        function ()
        {
            $j(this).attr("src", "/SeniorProject/img/slider/accordion/control/forward.png");
            $j("#accorControlBtnDesc").stop().fadeTo(0, 0.0);   
        }
    ); 
