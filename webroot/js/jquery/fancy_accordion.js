...
function setupAccordionImageSlider()
{
    ...
    $("#accordionContainer").find(".accordionImgDiv:first").css("border-left", "0px");
    
    // get list of all slided divs in slider
    var slidedDivsList = $("#accordionContainer .accordionImgDiv");
    // collect information on every div in to an global array
    g_slidedDivs = new Array;
    var firstDiv = $("#accordionContainer .accordionImgDiv:first");
    ...
    $("#accordionContainer").hover(
        ...
        {   
            ...
            $("#accordionContainer .accordionImgDiv").find(".slideDesc").stop().animate({opacity: 0.0}, 150);
        },
        function()
        {   
            // if slider is not fully loaded 
    ...
    $(".accordionImgDiv").hover(
        ...
        {   
            ...
            g_hoveredSlideIndex = $("#accordionContainer .accordionImgDiv").index(this);    
...
{
    var context = $('#accordionContainer')[0];
    // stop and set new animation of main image opacity
...
function setupLoadingAsynchronousImagesForAccordion()
{
    ...
    {
        // get list of all slided divs in slider
        var imgDivsList = $("#accordionContainer .asyncImgLoadAccordion");
        // collect information on every div in to an global array
         g_imgList = new Array;
         var firstDiv = $("#accordionContainer .accordionImgDiv:first");
...
function setupLoadingAsyncSlideStripImages()
{
    ...
    {
        // get list of all slided divs in slider
        var imgDivsList = $("#accordionContainer .slideStrip");
        // collect information on every div in to an global array
