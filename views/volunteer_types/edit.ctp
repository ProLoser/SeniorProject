...
<?php echo $this->Form->create('VolunteerType');?>
	<fieldset>
 		<legend><?php printf(__('Edit %s', true), __('Volunteer Type', true)); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('VolunteerType.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('VolunteerType.id'))); ?></li>
