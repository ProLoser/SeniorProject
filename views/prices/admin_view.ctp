...
<h2><?php  __('Price');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $price['Price']['foreign_id']; ?>
			&nbsp;
		</dd>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Original Slots Available'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $price['Price']['original_slots_available']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Current Slots Available'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $price['Price']['current_slots_available']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Line Item Count'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $price['Price']['line_item_count']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
