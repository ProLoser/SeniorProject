...
<?php echo $this->Form->create('RecruiterMeeting');?>
	<fieldset>
 		<legend><?php printf(__('Recruit Edit %s', true), __('Recruiter Meeting', true)); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('RecruiterMeeting.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('RecruiterMeeting.id'))); ?></li>
