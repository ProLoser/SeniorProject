        ...
        <h3>Volunteer</h3>
        <p class="about">As a developing nation dependent on agriculture and tourism, environmental protection and community initiatives are essential components for the sustainable development of Costa Rica. </p>
        <!-- Volunteer Slider --> 
            <div id="js-slideshow">                        
                <!-- slide 1 --> 
...
The adventure ends, travel home, Hasta Pronto!" /></li>
        ...
        <p class="about">These activities are more of the best that Costa Rica has to offer in outdoor adventure and appreciation of the spectacular natural surroundings. </p>
      	 	  <!-- ACCORDION IMAGE ROTATOR -->
          <div id="js-accordion_info">
              <!-- slide 1 -->
              <div id="slide1" class="accordionImgDiv_info">
                  <a href="index.html" id="slideimg1" class="accordionSlideImage_info asyncImgLoadAccordion_info" title="/img/adventure/CostaRica/Adv_CR-SliderMain01.jpg"></a>
                  <div class="accordionDescBack_info"></div>
                  <div class="accordionDesc_info">
                      <h3 class="accordionDescHeader_info">Surf Lessons at Samara Beach</h3>
                      <p>Costa Rica is famous for surfing in<br />
                      Latin America.</p>
                  </div>                    
                  <div class="slideStrip_info" title="/img/adventure/CostaRica/Adv_CR-SliderStrip01.jpg"></div>
                  <p class="slideDesc_info">Surf Lessons<br /> at Samara<br /> Beach</p>  
              </div>
                                                          
              <!-- slide 2 -->
              <div id="slide2" class="accordionImgDiv_info"> 
                  <a href="index.html" id="slideimg2" class="accordionSlideImage_info asyncImgLoadAccordion_info" title="/img/adventure/CostaRica/Adv_CR-SliderMain02.jpg"></a>
                  <div class="accordionDescBack_info"></div>
                  <div class="accordionDesc_info">
                      <h3 class="accordionDescHeader_info">Sea Kayaking in Samara Beach</h3>
                      <p>From Samara Beach, enjoy a leisurely paddle by kayak to<br />
                      Isla Chora.</p>
                  </div>                    
                  <div class="slideStrip_info" title="/img/adventure/CostaRica/Adv_CR-SliderStrip02.jpg"></div>
                  <p class="slideDesc_info">Sea Kayaking<br /> in Samara<br /> Beach</p> 
              </div>
                                
              <!-- slide 3 -->
              <div id="slide3" class="accordionImgDiv_info">
                  <a href="index.html" id="slideimg3" class="accordionSlideImage_info asyncImgLoadAccordion_info" title="/img/adventure/CostaRica/Adv_CR-SliderMain03.jpg"></a>
                  <div class="accordionDescBack_info"></div>
                  <div class="accordionDesc_info">
                      <h3 class="accordionDescHeader_info">Rinc&oacute;n de la Vieja National Park</h3>
                      <p>Explore Rinc&oacute;n de la Vieja National Park with<br />
                      two exciting activities.</p>
                  </div>                    
                  <div class="slideStrip_info" title="/img/adventure/CostaRica/Adv_CR-SliderStrip03.jpg"></div>
                  <p class="slideDesc_info">Rinc&oacute;n de<br /> la Vieja<br />National Park</p>  
              </div>
                                          
              <!-- slide 4 -->
              <div id="slide4" class="accordionImgDiv_info">
                  <a href="index.html" id="slideimg4" class="accordionSlideImage_info asyncImgLoadAccordion_info" title="/img/adventure/CostaRica/Adv_CR-SliderMain04.jpg"></a>
                  <div class="accordionDescBack_info"></div>
                  <div class="accordionDesc_info">
                      <h3 class="accordionDescHeader_info">Las Pailas Trail &amp; Simbiosis Mud Spa</h3>
                      <p>Visit one of the most famous national parks in<br />
                      all of Costa Rica. </p>
                  </div>                   
                 <div class="slideStrip_info"  title="/img/adventure/CostaRica/Adv_CR-SliderStrip04.jpg"></div>
                 <p class="slideDesc_info">Las Pailas Trail<br /> &amp; Simbiosis<br /> Mud Spa</p>  
              </div>           
                
              <!-- slide 5 -->
              <div id="slide5" class="accordionImgDiv_info">
                  <a href="index.html" id="slideimg5" class="accordionSlideImage_info asyncImgLoadAccordion_info" title="/img/adventure/CostaRica/Adv_CR-SliderMain05.jpg"></a> 
                  <div class="accordionDescBack_info"></div>
                  <div class="accordionDesc_info">
                      <h3 class="accordionDescHeader_info">Arenal Volcano Evening Hot Springs</h3>
                      <p>Soothe and soak sore muscles as you relax in natural<br />
                      hot springs at night.</p>
                  </div>    
                  <div class="slideStrip_info" title="/img/adventure/CostaRica/Adv_CR-SliderStrip05.jpg"></div>
                  <p class="slideDesc_info">Arenal Volcano<br /> Evening Hot<br /> Springs</p>  
              </div>
        ...
        <p class="about">Don't forget about the great optional extras such as a trip to the Galapagos Islands, Machu Picchu or our Spanish Lessons!</p>
			<div class="excursionWrapper">
                ...
                <div class="itemDesc">
                    ...
                    <p class="excur_text">
                        Spend three days in San Cristobal Island. This laid-back island is where sea lions loaf on the same beaches as locals and tourists and Frigate birds can be seen nesting on surrounding cliffs. 
                    </p>
                </div>
            ...
            <div class="excursionWrapper">
                ...
                <div class="itemDesc">
                    ...
                    <p class="excur_text">
                        7 Days & 7 nights of trekking through stunning peaks and lost Inca lands, colonial Cusco and exploring Machu Picchu- one of the New Seven Wonders of the World!
                    </p>
                </div>
            </div> <!-- ExcursionWrapper -->
