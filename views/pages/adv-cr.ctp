        ...
        <p class="about">These activities are more of the best that Costa Rica has to offer in outdoor adventure and appreciation of the spectacular natural surroundings. </p>
          ...
          <div id="js-accordion_info">
              ...
              <div id="slide1" class="accordionImgDiv_info">
                  <a href="index.html" id="slideimg1" class="accordionSlideImage_info asyncImgLoadAccordion_info" title="/SeniorProject/img/adventure/CostaRica/Adv_CR-SliderMain01.jpg"></a>
                  ...
                  <div class="slideStrip_info" title="/SeniorProject/img/adventure/CostaRica/Adv_CR-SliderStrip01.jpg"></div>
                  <p class="slideDesc_info">Surf Lessons<br /> at Samara<br /> Beach</p>  
              </div>
                                                          
              <!-- slide 2 -->
              <div id="slide2" class="accordionImgDiv_info"> 
                  <a href="index.html" id="slideimg2" class="accordionSlideImage_info asyncImgLoadAccordion_info" title="/SeniorProject/img/adventure/CostaRica/Adv_CR-SliderMain02.jpg"></a>
                  <div class="accordionDescBack_info"></div>
                  <div class="accordionDesc_info">
                  ...
                  <div class="slideStrip_info" title="/SeniorProject/img/adventure/CostaRica/Adv_CR-SliderStrip02.jpg"></div>
                  <p class="slideDesc_info">Sea Kayaking<br /> in Samara<br /> Beach</p> 
              </div>
                                
              <!-- slide 3 -->
              <div id="slide3" class="accordionImgDiv_info">
                  <a href="index.html" id="slideimg3" class="accordionSlideImage_info asyncImgLoadAccordion_info" title="/SeniorProject/img/adventure/CostaRica/Adv_CR-SliderMain03.jpg"></a>
                  <div class="accordionDescBack_info"></div>
                  <div class="accordionDesc_info">
                  ...
                  <div class="slideStrip_info" title="/SeniorProject/img/adventure/CostaRica/Adv_CR-SliderStrip03.jpg"></div>
                  <p class="slideDesc_info">Rinc&oacute;n de<br /> la Vieja<br />National Park</p>  
              </div>
                                          
              <!-- slide 4 -->
              <div id="slide4" class="accordionImgDiv_info">
                  <a href="index.html" id="slideimg4" class="accordionSlideImage_info asyncImgLoadAccordion_info" title="/SeniorProject/img/adventure/CostaRica/Adv_CR-SliderMain04.jpg"></a>
                  <div class="accordionDescBack_info"></div>
                  <div class="accordionDesc_info">
                 ...
                 <div class="slideStrip_info"  title="/SeniorProject/img/adventure/CostaRica/Adv_CR-SliderStrip04.jpg"></div>
                 <p class="slideDesc_info">Las Pailas Trail<br /> &amp; Simbiosis<br /> Mud Spa</p>  
              </div>           
                
              <!-- slide 5 -->
              <div id="slide5" class="accordionImgDiv_info">
                  <a href="index.html" id="slideimg5" class="accordionSlideImage_info asyncImgLoadAccordion_info" title="/SeniorProject/img/adventure/CostaRica/Adv_CR-SliderMain05.jpg"></a> 
                  <div class="accordionDescBack_info"></div>
                  <div class="accordionDesc_info">
                  ...
                  <div class="slideStrip_info" title="/SeniorProject/img/adventure/CostaRica/Adv_CR-SliderStrip05.jpg"></div>
        ...
        <p class="about">Don't forget about the great optional extras such as a trip to the Galapagos Islands, Machu Picchu or our Spanish Lessons!</p>
			<div class="excursionWrapper">
                <div class="imageWrapper">
                    <div class="image asyncImgLoad" title="/SeniorProject/img/adventure/CostaRica/cr-excur01.jpg"></div>
                </div>
                <div class="itemDesc">
            ...
            <div class="excursionWrapper">
                <div class="imageWrapper">
                    <div class="image asyncImgLoad" title="/SeniorProject/img/adventure/CostaRica/cr-excur02.jpg"></div>
                </div>
                <div class="itemDesc">
            ...
            <div class="excursionWrapper">
                <div class="imageWrapper">
                    <div class="image asyncImgLoad" title="/SeniorProject/img/adventure/CostaRica/cr-excur03.jpg"></div>
                </div>
                <div class="itemDesc">
