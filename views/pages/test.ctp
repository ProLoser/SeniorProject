...
<h2>Lightbox</h2>
<?php echo $this->Html->link($this->Html->image('adventure/Australia/comfort.jpg', array('alt' => 'Sydney Harbour')), '/img/adventure/Australia/comfort.jpg', array('class' => 'js-litebox', 'escape' => false)); ?>
<br />
...
<span id="accorControlBtnDesc"></span>
	<?php echo $this->Html->image('slider/accordion/control/back.png', array('class' => 'accorControlButton ie6PNGfix', 'id' => 'accorBackBtn'))?>
	<?php echo $this->Html->image('slider/accordion/control/pause.png', array('class' => 'accorControlButton ie6PNGfix', 'id' => 'accorPlayBtn'))?>
	<?php echo $this->Html->image('slider/accordion/control/forward.png', array('class' => 'accorControlButton ie6PNGfix', 'id' => 'accorForwardBtn'))?>
