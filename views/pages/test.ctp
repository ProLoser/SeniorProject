...
<div class="js-slideshow" id="slideshow">
    <?php echo $this->Html->image('adventure/Australia/aus-vol01.jpg', array('alt' => '<strong>Nature Sanctuary:</strong> <em>Make a difference to Australia&#39;s wildlife!</em><br />ISV has several projects located in nature sanctuaries. The goal is to conserve native animals in a relatively natural setting. Primary tasks vary and can include building and maintaining animal enclosures, fence building, vegetation removal, tree planting, and surveying. All of these tasks are directly related to the establishment or maintenance of the sanctuary and the species within it.') ); ?>
...
<div class="js-gallery">
    ...
    <?php echo $this->Html->image('adventure/Australia/Adv_Aus-Day05.jpg' ); ?>
    <?php echo $this->Html->image('adventure/Australia/Adv_Aus-Day06.jpg' ); ?>
...
<div id="js-accordion">
	...
	<div id="slide1" class="accordionImgDiv">
		<a href="index.html" id="slideimg1" class="accordionSlideImage asyncImgLoadAccordion" title="/SeniorProject/img/adventure/Australia/sydney.jpg|Sydney Harbour Sunset Cocktail Cruise|Enjoy the amazing Sydney Harbour on board this sunset cocktail cruise. The 1.5 hour trip cruises under the Sydney Harbour Bridge, up close to the Sydney Opera House, past the Royal Botanic Gardens while the sun sets on beautiful Sydney. All this while enjoying a complimentary drink and Australian Cheeses."></a>
		<div class="accordionDescBack"></div>
		<div class="accordionDesc">
			<p class="accordionDescHeader">Sydney Harbour</h3>
			
		</div>                    
		<div class="slideStrip" title="/SeniorProject/img/adventure/Australia/sydneystrip.jpg"></div>
		<p class="slideDesc">Sydney<br />Harbour</p>  
	</div>
											  
	<!-- slide 2 -->
	<div id="slide2" class="accordionImgDiv"> 
		<a href="index.html" id="slideimg2" class="accordionSlideImage asyncImgLoadAccordion" title="/SeniorProject/img/adventure/Australia/bluemountains.jpg|Rappelling in the Blue Mountains|Experience the adrenaline rush of rappelling down the beautiful sandstone cliffs of the World Heritage listed Blue Mountains. Participants will build their skills and confidence on rappels of multiple heights - the ultimate challenge is 180ft high!"></a>
		<div class="accordionDescBack"></div>
		<div class="accordionDesc">
			<p class="accordionDescHeader">Blue Mountains</h3>
			
		</div>                    
		<div class="slideStrip" title="/SeniorProject/img/adventure/Australia/bluemountainsstrip.jpg"></div>
		<p class="slideDesc">Blue<br />Mountains</p> 
	</div>
					
	<!-- slide 3 -->
	<div id="slide3" class="accordionImgDiv">
		<a href="index.html" id="slideimg3" class="accordionSlideImage asyncImgLoadAccordion" title="/SeniorProject/img/adventure/Australia/bryonbay.jpg|Learn to Surf in Byron Bay|Surfing is an Australian tradition and Byron Bay is one of Australia's most popular surfing spots. Surfing professionals will teach you the basics to the advanced skills of surfing in some of the best waves in Australia."></a>
		<div class="accordionDescBack"></div>
		<div class="accordionDesc">
			<p class="accordionDescHeader">Bryon Bay</h3>
			
		</div>                    
		<div class="slideStrip" title="/SeniorProject/img/adventure/Australia/bryonbaystrip.jpg"></div>
		<p class="slideDesc">Bryon <br />Bay</p>  
	</div>
							  
	<!-- slide 4 -->
	<div id="slide4" class="accordionImgDiv">
		<a href="index.html" id="slideimg4" class="accordionSlideImage asyncImgLoadAccordion" title="/SeniorProject/img/adventure/Australia/frasierisland.jpg|Fraser Island Lake Wabby Tour|Lake Wabby is a stunning emerald green freshwater lake on the amazing Fraser Island, which is the largest sand island in the world. Lake Wabby is great for swimming and you may be lucky enough to see friendly catfish and long neck turtles! To reach Lake Wabby we will drive a short distance along 75-mile Beach, and then take an interpreted hike across the ever-changing sand dunes."></a>
		<div class="accordionDescBack"></div>
		<div class="accordionDesc">
			<p class="accordionDescHeader">Frasier Island</h3>
			
		</div>                   
	   <div class="slideStrip" title="/SeniorProject/img/adventure/Australia/frasierislandstrip.jpg"></div>
	   <p class="slideDesc">Frasier<br />Island</p>  
	</div>           
	
	<!-- slide 5 -->
	<div id="slide5" class="accordionImgDiv">
		<a href="index.html" id="slideimg5" class="accordionSlideImage asyncImgLoadAccordion" title="/SeniorProject/img/adventure/Australia/whitsundayislands.jpg|Ocean Rafting the Beautiful Whitsunday Islands|This is an adrenaline filled full day eco-adventure tour through the Whitsunday Islands to postcard perfect Whitehaven beach. Ocean Rafting is the most exhilarating and fastest way to tour the Whitsunday Islands. The day includes exploring Whitehaven Beach, snorkeling pristine coral reefs and tropical island guided walks. A buffet lunch is also included. Whitehaven Beach is recognized as one of the most beautiful beaches in the world with its amazing blue water and white sand."></a> 
		<div class="accordionDescBack"></div>
		<div class="accordionDesc">
			<p class="accordionDescHeader">Whitsunday Islands</h3>
			
		</div>    
		<div class="slideStrip" title="/SeniorProject/img/adventure/Australia/whitsundayislandsstrip.jpg"></div>
