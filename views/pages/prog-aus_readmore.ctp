<?php $this->layout = 'full-width'; ?>
    ...
    <ul class="rightColumn">
        ...
        <li class="readmore_links"><a href="#">Australia</a></li>
        <li class="readmore_links"><a href="#">Costa Rica</a></li>
        <li class="readmore_links"><a href="#">Dominican Republic</a></li>
        <li class="readmore_links"><a href="#">Eastern Europe</a></li>
        <li class="readmore_links"><a href="#">Ecuador</a></li>
        <li class="readmore_links"><a href="#">New Zealand</a></li>
        <li class="readmore_links"><a href="#">South Africa</a></li>
        <li class="readmore_links"><a href="#">Thailand</a></li>
