...
<?php echo $this->Form->create('TripPage');?>
	<fieldset>
 		<legend><?php printf(__('Edit %s', true), __('Trip Page', true)); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('TripPage.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('TripPage.id'))); ?></li>
