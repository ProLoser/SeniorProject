...
<h2><?php  __('Menu');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Parent Sid'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $menu['Menu']['parent_sid']; ?>
			&nbsp;
		</dd>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(sprintf(__('Edit %s', true), __('Menu', true)), array('action' => 'edit', $menu['Menu']['id'])); ?> </li>
		<li><?php echo $this->Html->link(sprintf(__('Delete %s', true), __('Menu', true)), array('action' => 'delete', $menu['Menu']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $menu['Menu']['id'])); ?> </li>
